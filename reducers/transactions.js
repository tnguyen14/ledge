...
import { ADD_TRANSACTION_SUCCESS, UPDATE_TRANSACTION_SUCCESS, REMOVE_TRANSACTION_SUCCESS } from '../actions/transaction.js';
export default function transactions(state = {}, action) {
  switch (action.type) {
    ...
    case LOAD_WEEK_SUCCESS:
      ...
      return action.data.transactions.reduce(function addTransation(currentState, transaction) {
