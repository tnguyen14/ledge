import { LOAD_ACCOUNT_SUCCESS, INTEND_TO_REMOVE_TRANSACTION, CANCEL_REMOVE_TRANSACTION } from '../actions/account.js';
...
export default function account(state = initialState, action) {
  switch (action.type) {
    case LOAD_ACCOUNT_SUCCESS:
      const merchants = Object.keys(action.data.merchants_count).filter(merchant => {
