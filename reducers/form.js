...
import { INPUT_CHANGE, SUBMIT_TRANSACTION, SUBMIT_TRANSACTION_FAILURE, RESET_FORM } from '../actions/form.js';
import { ADD_TRANSACTION_SUCCESS, UPDATE_TRANSACTION_SUCCESS } from '../actions/transaction.js';
...
let defaultCategory = '';
let defaultSource = ''; // abstract this into a function so it can be called again later
...
const fields = [{
  ...
  label: 'Span',
  name: 'span',
  hint: 'Number of weeks the transaction should be spread over, such as 1, 4, 13, 52',
  attributes: {
    min: 0,
    step: 1
  }
