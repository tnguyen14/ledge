...
import React, { useEffect, useRef, useCallback } from 'https://cdn.skypack.dev/react@17';
import { useSelector, useDispatch } from 'https://cdn.skypack.dev/react-redux@7';
import Button from 'https://cdn.skypack.dev/react-bootstrap@1/Button';
import Field from './Field.js';
import { INPUT_CHANGE, SUBMIT_TRANSACTION_FAILURE, SUBMIT_TRANSACTION, resetForm } from '../../actions/form.js';
...
function Form(props) {
  ...
  return /*#__PURE__*/React.createElement("form", {
    ...
    method: "POST"
  }, /*#__PURE__*/React.createElement("h2", null, "Add a new transaction"), fields.map(field => {
    ...
    type: "submit",
    onClick: submitForm
  }, buttonAttrs), action), /*#__PURE__*/React.createElement(Button, _extends({
