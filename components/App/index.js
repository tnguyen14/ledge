...
import { useHistory, useLocation } from 'https://cdn.skypack.dev/react-router-dom@5';
...
function App() {
  ...
  useEffect(() => {
    ...
    const now = new Date(); // reload if haven't been loaded in an hour
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "app-top"
  }, /*#__PURE__*/React.createElement(Form, null), /*#__PURE__*/React.createElement(AccountStats, null)), /*#__PURE__*/React.createElement(Weeks, null), /*#__PURE__*/React.createElement(DeleteDialog, null), /*#__PURE__*/React.createElement(Notification, null));
}
