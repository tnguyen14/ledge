import { createSlice, createAsyncThunk } from 'https://esm.sh/@reduxjs/toolkit@2';
import { getTransactions } from '../util/api.js';
export const loadTransactions = createAsyncThunk('transactions/loadTransactions', async ({
  start,
  end
}) => {
