...
export function decorateTransaction(params) {
  ...
  const budgetStart = params.budgetStart ? new Date(`${params.budgetStart} 00:00`).toISOString() : undefined;
  const budgetEnd = params.budgetEnd ? new Date(`${params.budgetEnd} 00:00`).toISOString() : undefined;
